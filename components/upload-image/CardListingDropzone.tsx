...
export const CardListingDropzone = ({ onDrop }: OnDropProps) => {
  ...
  return (
    <section className='m-4 space-y-2'>
      <div
        {...getRootProps()}
        className={cn(
          'w-72 flex flex-col justify-center items-center p-3 border-2 border-dashed rounded-lg cursor-pointer',
      ...
      >
        ...
        {!isDragActive && (
          <div className='space-y-2 w-full text-center'>
            <IoIosCloudUpload className='animate-in text-purple-600 w-full' size={28} />
